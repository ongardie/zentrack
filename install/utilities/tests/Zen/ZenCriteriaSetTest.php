<?{ /* -*- Mode: C; c-basic-indent: 3; indent-tabs-mode: nil -*- ex: set tabstop=3 expandtab: */ 
  ...
  /**
   * Test the ZenCriteriaSet.php class file and its methods
   *
   ...
   *
   * This test relies on the ZenCriteriaSetTest.xml 
   * file to provide test data
   *
   * @package PHPUnit
   */
  class ZenCriteriaSetTest extends Test {

    /** Constructor */
    function ZenCriteriaTestTest() {
      //$this->obj = new ZenCriteriaSet();
    }
