<?{ /* -*- Mode: C; c-basic-indent: 3; indent-tabs-mode: nil -*- ex: set tabstop=3 expandtab: */ 
  ...
  /**
   * Test the ZenFormGenerator.php class file and its methods
   *
   ...
   *
   * This test relies on the ZenFormGeneratorTest.xml 
   * file to provide test data
   *
   * @package PHPUnit
   */
  class ZenFormGeneratorTest extends Test {

    /** Constructor */
    function ZenFormGeneratorTest() {
      //$this->obj = new ZenFormGenerator();
    }
