<?{ /* -*- Mode: C; c-basic-indent: 3; indent-tabs-mode: nil -*- ex: set tabstop=3 expandtab: */ 
  ...
  /**
   * Test the ZenXMLParser.php class file and its methods
   *
   ...
   *
   * This test relies on the ZenXMLParserTest.xml 
   * file to provide test data
   *
   * @package PHPUnit
   */
  class ZenXMLParserTest extends Test {

    /** Constructor */
    function ZenXMLParserTest() {
      //$this->obj = new ZenXMLParser();
    }
