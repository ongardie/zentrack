<?{ /* -*- Mode: C; c-basic-indent: 3; indent-tabs-mode: nil -*- ex: set tabstop=3 expandtab: */ 
  ...
  /**
   * Test the ZenXNode.php class file and its methods
   *
   ...
   *
   * This test relies on the ZenXNodeTest.xml 
   * file to provide test data
   *
   * @package PHPUnit
   */
  class ZenXNodeTest extends Test {

    /** Constructor */
    function ZenXNodeTest() {
      //$this->obj = new ZenXNode();
    }
