<?{ /* -*- Mode: C; c-basic-indent: 3; indent-tabs-mode: nil -*- ex: set tabstop=3 expandtab: */ 
  ...
  /**
   * Test the ZenDbTypeInfo.php class file and its methods
   *
   ...
   *
   * This test relies on the ZenDbTypeInfoTest.xml 
   * file to provide test data
   *
   * @package PHPUnit
   */
  class ZenDbTypeInfoTest extends Test {

    //var $obj;

    /** Constructor */
    function ZenDbTypeInfoTest() {
      //$this->obj = new ZenDbTypeInfo();
    }
