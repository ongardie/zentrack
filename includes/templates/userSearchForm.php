...
<tr>
  ...
  <td class="bars">
    <input type="text" name="search_params[uid]" value="<?=strip_tags($search_params["uid"])?>" size="12" maxlength="12">
  </td>
</tr>
<tr>
  <td class="bars">
...
<tr>
  ...
  <td class="bars">
    ...
    <input type="text" name="search_params[access]" 
	value="<?=strip_tags($search_params["access"])?>"
