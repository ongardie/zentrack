...
<ul>
  ...
  <ul>
    ...
    <br><span class="small">(<?=tr("edit,delete,change access")?>)</span>
  </ul>
      
  <b><?=tr("Ticket Administration")?></b>
  <ul>
  ...
  <ul>
      ...
      <br><span class="small">(<?=tr("Edit the priorities list")?>)</span>
      <br><b><a href='<?=$rootUrl?>/admin/systems.php'><?=tr("Edit Systems")?></a></b>
      <br><span class="small">(<?=tr("Edit the systems list")?>)</span>
