...
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('New User')?>'>
    <a href='<?=$rootUrl?>/admin/addUser.php' class='leftNavLink'><?=$hk->ll("New User")?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Edit Users')?>'>
...
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Edit Tickets')?>'>
    <a href='<?=$rootUrl?>/admin/editTicket.php' class='leftNavLink'><?=$hk->ll('Edit Tickets')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Edit Field Map')?>'>
...
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Bins')?>'>
    <a href='<?=$rootUrl?>/admin/bins.php' class='leftNavLink'><?=$hk->ll('Bins')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Priorities')?>'>
    <a href='<?=$rootUrl?>/admin/priorities.php' class='leftNavLink'><?=$hk->ll('Priorities')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Systems')?>'>
    <a href='<?=$rootUrl?>/admin/systems.php' class='leftNavLink'><?=$hk->ll('Systems')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Tasks')?>'>
    <a href='<?=$rootUrl?>/admin/tasks.php' class='leftNavLink'><?=$hk->ll('Tasks')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Types')?>'>
...
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Data Groups')?>'>
    <a href='<?=$rootUrl?>/admin/groups.php' class='leftNavLink'><?=$hk->ll('Data Groups')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Behaviors')?>'>
    <a href='<?=$rootUrl?>/admin/behaviors.php' class='leftNavLink'><?=$hk->ll('Behaviors')?></a>
  </td>
</tr>
<tr>
  <td class='leftNavMenu' <?=$nav_rollover_text?> title='<?=$hk->tt('Configuration')?>'>
