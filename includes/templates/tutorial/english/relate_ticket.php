...
<p>Tickets in the <?=tr('Related')?> tab can be viewed by simply clicking on
the row of the ticket.

<p><b>Adding Relationships</b></p>

<p>A ticket can be added to the <?=tr('Related')?> tab simply by clicking on the
'<?=tr('Relate')?>' action button.
