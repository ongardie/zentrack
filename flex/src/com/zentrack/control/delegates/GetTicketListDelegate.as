package com.zentrack.control.delegates
{
	 ...
	 */
	public class GetTicketListDelegate
	{
		...
		public function GetTicketListDelegate(responder:Responder) : void {
		...
		public function loadTickets() : void {
			...
			parameters.bin_id     = __model.userInfo.homeBinID + "\t" +
									__model.allDepots;

			parameters.limit      = __model.ticketLimit;
